document.addEventListener('DOMContentLoaded', function() {
    ...
    saleBtn.addEventListener('click', function() {
        window.location.href = `realizarVenta.html?title=${encodeURIComponent(selectedCarTitle)}`;
    });

    // Función de búsqueda
    searchInput.addEventListener('input', function() {
        const filter = searchInput.value.toLowerCase();
        const carItems = serviceContainer.getElementsByClassName('service-item');

        Array.from(carItems).forEach(function(item) {
